...
<taglib:table items="${ personList }" url="test.jsp">
	<taglib:column property="id" label="絪腹" />
	<taglib:column property="name" label="﹎" />
	<taglib:column property="age" label="闹" />
	<taglib:column property="sex" label="┦" />
	<taglib:column property="address" label="" />
	<taglib:column property="telephone" label="筿杠" />
	<taglib:column property="mobile" label="も诀" />
	<taglib:column property="city" label="カ" />
	<taglib:column property="deleted" label="琌埃" />
</taglib:table>
